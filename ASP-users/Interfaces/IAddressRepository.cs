...
namespace ASP_users.Interfaces
{
    public interface IAddressRepository
    {
        ...
        Task<IEnumerable<Address>> GetUserAddresses(Guid userId); // отримання списку адрес певного юзера (виводиться в аккардіон)
        ...
        Task UpdateAddress(int addressId, Address address); // оновлення інформації одразу в двух таблицях (addresses і useraddresses)

        Task AddAddressToUser(Guid userId, Address address); // створення запису одразу в двух таблицях (addresses і useraddresses)
